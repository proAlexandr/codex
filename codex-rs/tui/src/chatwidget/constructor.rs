...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let placeholder = PLACEHOLDERS[rng.random_range(0..PLACEHOLDERS.len())][..0].to_string();
        let side_placeholder =
            SIDE_PLACEHOLDERS[rng.random_range(0..SIDE_PLACEHOLDERS.len())][..0].to_string();
        ...
        let mut widget = Self {
            ...
            status_line_cost_lookup_complete: false,
